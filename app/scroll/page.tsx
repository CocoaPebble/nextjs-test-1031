...
const IndexComponent: React.FC = () => {
  const sections: Section[] = [
    {
      ...
      title: "标题1",
      content:
        "这里是标题1的内容...Hi Aleksandar, I was captivated by your profile as an accomplished member of UPS. Your journey and experiences truly resonate with my aspirations, especially considering my strong willing to join in UPS. I would be extremely grateful if you would consider connecting with me.",
    },
    {
      id: "section2",
      title: "标题2",
  ...
  return (
    <div className="container mx-auto px-40 flex">
      <div className="w-1/4">
        {/* 左侧边栏 */}
